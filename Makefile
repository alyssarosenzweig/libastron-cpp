...
all: ConnectionRepository.o Connection.o AIRepository.o test_air.o ChannelWatcher.o
	$(CXX) test_air.o ConnectionRepository.o AIRepository.o Connection.o ChannelWatcher.o $(FLAGS) $(LIBS) -o test_air
